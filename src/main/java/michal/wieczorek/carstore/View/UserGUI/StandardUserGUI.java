...
public class StandardUserGUI extends JFrame{
    ...
    private JScrollPane fillCarsATable(){
            ...
            Action buttonAction = new AbstractAction()
		{
            ...
            modelCarA.addRow(new Object[]{car.getName(), car.getMark(), isAvaibleCar(car.getIsAvaible()), CarA.getPrice(),
    ...
    private JScrollPane fillCarsBTable(){
            ...
            Action buttonAction = new AbstractAction()
		{
			public void actionPerformed(ActionEvent e)
			{
             ...
             modelCarB.addRow(new Object[]{car.getName(), car.getMark(), isAvaibleCar(car.getIsAvaible()), CarB.getPrice(),
                checkIfCellIsBlock(car.getIsAvaible(),
